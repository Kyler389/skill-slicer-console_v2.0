...
![slicer-console complete workflow](references/workflow-canvas.png)
...
>
> 📓 **Obsidian users**: Open `Workflow.canvas` in the vault for an interactive flowchart; double-click any node to navigate to the source file. Use `Growth Module.base` for a table-view dashboard of all records.
